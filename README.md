...
## 💻 System requirements
1.Supports Apple Silicon (M-series) and Intel Macs

2.Supports macOS 14 or later

## ⬇️ How to download
1. Download file `CTM.dmg`.
2. Open file `CTM.dmg` and drag it into the Applications folder
...
1. **Right-click** (or Control-click) on `CTM.app` → select **Open**.
...
- **macOS 14/15**: System Settings > Privacy & Security > **Accessibility**
